             ...
             <div class="col-12">
                 <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        @isset($scategory_slug)
                            <li><a href="{{route('product.category',['category_slug'=>$category_slug])}}">
                                @php
                                    $str = $category_slug;
                                    $usecate = preg_replace("~[^a-z0-9:]~i", " ", $str);
                                    echo $usecate;
                                @endphp
                            </a><i class="ti-arrow-right"></i></li>
                        @endisset
                        <li class="active"><a href="#" style="cursor: default;">{{$category_name}}</a></li>
                     </ul>
                  </div>
            </div>
        </div>

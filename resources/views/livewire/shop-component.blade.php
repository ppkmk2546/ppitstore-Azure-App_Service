            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active"><a href="/shop">All Product Categories</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="shop-top">
                            ...
                            <ul class="view-mode">
                                <li><a href="/shop" title="Refresh this page."><i class="fa fa-refresh" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                        <!--/ End Shop Top -->
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        @if(count($products))
                            <div class="pagination">
                                {{$products->appends(request()->all())->links('livewire-pagination-links')}}
                            </div>
                        @elseif(!count($products))
                            <div class="pagination">
                                <div class="alert alert-danger">
                                    <strong>ในหน้านี้ไม่มีสินค้าให้แสดงผล! กรุณากดกลับไปหน้าแรก.</strong>
                                </div>
                                <div class="pagination">
                                    {{$products->appends(request()->all())->links('livewire-pagination-links')}}
                                </div>

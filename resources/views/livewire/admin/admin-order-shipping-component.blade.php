<div>
    @section('title') {{'| Shipping Orders'}}@endsection
          ...
          <!--Start Dashboard Content-->
            <div class="row">
             <div class="col-12 col-lg-12">
               <div class="card">
                 <div class="card-header" style="font-size: 20px">คำสั่งซื้อที่อยู่ระหว่างการจัดส่ง
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 0rem;">
                                                <div align="center" style="vertical-align: middle;">
                                                    ...
                                                    <button type="submit" class="btn btn-info btn-sm">Check Status</button><br>
                                                </div>
                                            </td>

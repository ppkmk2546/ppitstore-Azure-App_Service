<div>
    @section('title') {{'| Pack&AddTracking Orders'}}@endsection
          ...
          <!--Start Dashboard Content-->
            <div class="row">
             <div class="col-12 col-lg-12">
               <div class="card">
                 <div class="card-header" style="font-size: 20px">คำสั่งซื้อที่รอการบรรจุ และใส่หมายเลขติดตามพัสดุ
                  <div class="card-action">
                   ...
                   <div class="table-responsive">
                       ...
                       @elseif (Session::has('tracking_message'))
                         <div align="center" class="alert alert-success">{{ Session::get('tracking_message') }}</div>
                       @endif
                                            ...
                                            <td style="padding: 10px;">
                                                <div class="dropdown" align="center" style="vertical-align: middle;">
                                                    ...
                                                    @elseif($order->status == "packing")
                                                        <button type="submit" class="btn btn-info btn-sm">Add TrackNumber</button><br>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                @else
                                    <tr>
                                        <td style="padding: 20px" colspan="10" class="text-center">
                                            <p id="refreshtry" style="margin-bottom: .65rem; font-size: 18px;">ไม่มีคำสั่งซื้อให้จัดการ</p>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>

            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 15px;">
                    ...
                    <div class="login-form" style="padding: 25px 10px; 25px 10px">
                        <h2>Register</h2>
                        <p>กรุณาลงทะเบียนเพื่อซื้อสินค้าในเว็บไซต์</p>
                        <!-- Form -->
                        <x-jet-validation-errors class="mb-4" />
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" placeholder="Your UserName" required autofocus autocomplete="name">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Your Email<span>*</span></label>
                                        <input type="email" name="email" placeholder="Your email address" :value="old('email')" required autofocus>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Your Password<span>*</span></label>
                                        <input id="password-field" type="password" name="password" placeholder="Password" required autocomplete="new-password">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
